  ...
  mixins: [fbDatabase],
    methods: {
        ...
        updateMyFriends: function updateMyFriends() {
            fbDatabaseMaintain.methods.getFriendListInDatabase(this.otherUsers, this.userUid).then((friends) => {
    ...
    myFriends(newValue, oldValue) {
      console.log("oldValue for myFriends");
      console.log(oldValue);
      console.log("newValue for myFriends");
      console.log(newValue);
    }
  },
  mounted() {
