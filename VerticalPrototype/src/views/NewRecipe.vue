  ...
  <div class="newrecipe">
    <div class="step" v-show="showRecipeMeta">
      ...
      <form>
        ...
        <input type="text" v-model="recipeName" id="rezeptname" @change="toggleColor('rezeptname')" required placeholder="Ein fantastisches Rezept">
        <label for="rezeptbeschreibung">Gebe hier eine kurze Beschreibung des Rezepts an:</label>
        <input type="textarea" v-model="recipeDescription" id="rezeptbeschreibung" @change="toggleColor('rezeptbeschreibung')" required placeholder="Eine kurze Beschreibung">
        <label for="category">Welcher Kategorie würdest du das Rezept zuordnen? </label>
        <div class="category" v-for="(category,index) in categories" :key="index">
          <input type="text" v-model="category.name" placeholder="Vorspeise" id="rezeptkategorie" @change="toggleColor('rezeptkategorie')">
          <div class="recipe-actions-buttons rm-spacer">
            <button type="button" class="other-button" @click="removeCategory(index)" v-show="index || ( !index && categories.length > 1)"><i><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!-- Font Awesome Free 5.15.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/></svg></i> Kategorie entfernen</button>
            <button type="button" class="other-button" @click="addCategory(index)" v-show="index == categories.length-1"><i><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!-- Font Awesome Free 5.15.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M416 208H272V64c0-17.67-14.33-32-32-32h-32c-17.67 0-32 14.33-32 32v144H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h144v144c0 17.67 14.33 32 32 32h32c17.67 0 32-14.33 32-32V304h144c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/></svg></i> Weitere Kategorien angeben</button>
          </div>
        </div>
    ...
    <div class="step" v-show="showPortion">
      ...
      <form>
        ...
        <input type="number" v-model="portion" id="rezeptportion" @change="toggleColor('rezeptportion')" placeholder="1">
    ...
    <div class="step" v-show="showDifficulty">
      ...
      <form>
        ...
        <select name="schwierigkeitsgrad" v-model="difficultyLevel" id="rezeptschwierigkeitsgrad" @change="toggleColor('rezeptschwierigkeitsgrad')">
    ...
    <div class="step" v-show="showUtensils">
      ...
      <form>
        <div class="untensil" v-for="(utensil,index) in utensils" :key="index">
          ...
          <input type="text" v-model="utensil.name" placeholder="Kitchen Aid" id="rezepthaushaltsgerät" @change="toggleColor('rezepthaushaltsgerät')">
          <div class="recipe-actions-buttons rm-spacer">
    ...
    <div class="step" v-show="showIngredient">
      ...
      <div class="untensil" v-for="(ingredient,index) in ingredients" :key="index">
        ...
        <input type="text" v-model="ingredient.name" id="zutatname" @change="toggleColor('zutatname')" placeholder="Zitrone">
        ...
        <div v-for="(origin,i) in ingredient.origins" :key="'origin-'+i">
          ...
          <div class="recipe-actions-buttons rm-spacer">
          <input type="text" v-model="origin.name" id="zutatherkunft" @change="toggleColor('zutatherkunft')" value="" placeholder="Wochenmarkt">
        ...
        <div v-for="(altIng,t) in ingredient.alternativeIngredients" :key="'altIng-'+t">
          ...
          <div class="side-border">
            <input type="text" v-model="altIng.name" id="altzutatname" @change="toggleColor('altzutatname')" value="" placeholder="Limette">
            <label for="mengenangabe">Wie viel wird davon benötigt?</label> 
    ...
    <div class="step" v-show="showPreptime">
      ...
      <form>
        ...
        <input type="number" v-model="prepTime" id="rezeptzubereitungszeit" @change="toggleColor('rezeptzubereitungszeit')" value="" placeholder="15">
    ...
    <div class="step" v-show="showResttime">
      ...
      <form>
        ...
        <input type="number" v-model="restTime" id="rezeptruhezeit" @change="toggleColor('rezeptruhezeit')" value="" placeholder="120">
    ...
    <div class="step" v-show="showCooktime">
      ...
      <form>
        ...
        <input type="number" v-model="cookTime" value="" id="rezeptkochzeit" @change="toggleColor('rezeptkochzeit')" placeholder="10">
    ...
    <div class="step" v-show="showInstructions">
      ...
      <form>
        ...
        <div class="instructions" v-for="(instruct,index) in instructions" :key="index">
          ...
          <input type="text" v-model="instruct.description" id="rezeptzubereitungschritt" @change="toggleColor('rezeptzubereitungschritt')" value="" placeholder="Die Zitronen schälen und genießen.">
          
          <!-- Historical Note -->
          <div v-for="(note,i) in instruct.historicalNote" :key="'h-note-'+i">
            <label for="zutatherkunft">Woran möchtest du andere erinnern?</label>
            <div class="recipe-actions-buttons rm-spacer">
              <input type="text" v-model="note.text" id="rezeptzubereitunganekdote" @change="toggleColor('rezeptzubereitunganekdote')" placeholder="Damals war alles lustiger...">
          ...
          <div v-for="(tip,i) in instruct.tipsAndTricks" :key="'tnt-'+i">
            ...
            <div class="recipe-actions-buttons rm-spacer">
              <input type="text" v-model="tip.text" id="rezeptzubereitungtipp" @change="toggleColor('rezeptzubereitungtipp')" placeholder="Das Messer fest in der Hand halten und Vs schneiden...">
...
export default {
  ...
  computed: {
    ...
    recipeHead() {
      ...
      recipeHead["categories"] = this.categories;
      var author = {};
  ...
  methods: {
    ...
    goToStep(prevPage, nextPage) {
      if(prevPage == null && nextPage == null) {
        ...
        "rezeptkategorie",
        "rezeptportion",
        "rezeptschwierigkeitsgrad",
        "rezepthaushaltsgerät",
        "zutatname",
        "zutatmenge",
        "zutateinheit",
        "zutatherkunft",
        ...
        "rezeptruhezeit",
        "rezeptkochzeit",
        "rezeptzubereitungschritt",
        "rezeptzubereitunganekdote",
        "rezeptzubereitungtipp",
      ];
      var openInput = false;
      elementsOnPage.forEach(element => {
        if(document.getElementById(element).classList.contains("edited-but-not-saved"))openInput = true
      }); 
      if(!openInput){
        switch (prevPage) {
          case 'showRecipeMeta':
    ...
    toggleColor(elementID) {
      document.getElementById(elementID).classList.add("edited-but-not-saved");
    },
    removeBorder() {
      var elementsOnPage = [
        "rezeptname",
      ...
      elementsOnPage.forEach(element => {
        document.getElementById(element).classList.remove("edited-but-not-saved");
      }); 
    }
  }
};
...
<style>
  ...
  .edited-but-not-saved {
    border: 3px solid var(--highlight-orange-2);
  }
  .edited-but-not-saved:before {
    content:"Bitte Speichern!";
  }
</style>
